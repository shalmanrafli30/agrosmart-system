            ...
            <div className="mt-6 ml-6 bg-abu p-4">
                ...
                <form action="#" className="max-w-screen-md mx-0 space-y-10">
                    <div id="idArea" className="flex space-x-5 items-center mb-2">
                        ...
                        <input type="text" name="idArea" id="" className="bg-white border border-abu3 text-black text-sm w-full p-2" value="SITE001"/>
                    </div>
                    <div id="namaArea" className="flex space-x-5 items-center mb-2">
                        ...
                        <input type="text" name="namaArea" id="" className="bg-white border border-abu3 text-black text-sm w-full p-2" value="Lingkungan"/>
                    </div>
                    <div id="lokasi" className="flex space-x-5 items-center mb-2">
                        ...
                        <select name="lokasi" id="" className="bg-white border border-abu3 text-black text-sm w-full p-2 font-bold">
                    ...
                    <div id="tipe" className="flex space-x-5 items-center mb-2">
                        ...
                        <select name="tipe" id="" className="bg-white border border-abu3 text-black text-sm w-full p-2 font-bold">
